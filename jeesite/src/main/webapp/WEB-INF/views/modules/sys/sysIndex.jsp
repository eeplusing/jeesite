	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright&nbsp;&copy;&nbsp;2016-${fns:getConfig('copyrightYear')} <%-- <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a>&nbsp;${fns:getConfig('version')} --%> - 西安数驰信息科技有限公司&nbsp;<a href="https://eplusing-eplusing.rhcloud.com" target="_blank">All Rights Reserved</a> 
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
