...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xuygtest/testData/">单表列表</a></li>
		<shiro:hasPermission name="xuygtest:testData:edit"><li><a href="${ctx}/xuygtest/testData/form">单表添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="testData" action="${ctx}/xuygtest/testData/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="xuygtest:testData:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="testData">
			<tr>
				<td><a href="${ctx}/xuygtest/testData/form?id=${testData.id}">
					${testData.user.name}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="xuygtest:testData:edit"><td>
    				<a href="${ctx}/xuygtest/testData/form?id=${testData.id}">修改</a>
					<a href="${ctx}/xuygtest/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该单表吗？', this.href)">删除</a>
